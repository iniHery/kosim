    ...
    <section className="bg-white w-full max-w-full h-full">
      ...
      <div className="mx-4">
        <Dialog>
          ...
          <DialogContent className="sm:max-w-[425px] w-[88%] h-[88%] bg-white rounded-[8px]">
            <DialogHeader>
              <DialogTitle className="text-left pb-2 text-xl">
                Tambah Data Pinjaman Nasabah
              </DialogTitle>
            </DialogHeader>
            ...
            <DialogFooter>
              <Button
                type="submit"
                className="bg-[#4F78E1] text-white rounded-[5px] mt-0"
              >
                Simpan
              </Button>
            </DialogFooter>
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1" className="border-t">
            <div className="flex flex-wrap items-center">
              ...
              <Link
                href="/member/CustomerLoanDetail"
                className="grid grid-cols-2 grid-rows-1 w-[86%]"
              >
                <div className="text-sm">Nama Lengkap</div>
                <div className="text-sm">Ari</div>
              </Link>
            </div>
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            <div className="flex flex-wrap items-center">
              ...
              >
                <div className="text-sm">Nama Lengkap</div>
                <div className="text-sm">Putri</div>
              </Link>
            </div>
            <AccordionContent className="pl-12">
              <div className="grid grid-cols-2 gap-10 grid-rows-1 w-[86%]">
...
export default DataPinNasabahPage;
